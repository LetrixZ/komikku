...
class KoharuClientV1(
     ...
     * Terminates when the operation reaches a terminal status ("completed", "completed_with_errors", "failed"),
     ...
     * @return True if completed successfully, false if the operation failed
     */
